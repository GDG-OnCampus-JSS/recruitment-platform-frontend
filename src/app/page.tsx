  ...
  return (
    <>
      <SmoothScroll>
        ...
        <motion.section
          style={{ opacity }}
          className="sticky top-0 grid h-full min-h-screen w-full place-content-center overflow-hidden bg-cover bg-no-repeat leading-[1em] md:bg-home-1"
        >
          <motion.div style={{ scale }}>
            <div className="group absolute h-screen w-screen bg-slate-100/10"></div>
            <Logo />
