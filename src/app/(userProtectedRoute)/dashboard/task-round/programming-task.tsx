...
export const ProgrammingTask = () => {
  return (
    <div className="mt-10 space-y-8 text-center">
      <h2 className="text-theme pb-2 text-[28px] font-bold">Programming Club Contest</h2>
      <div className="space-y-6">
        <div className="mx-auto max-w-2xl">
          <p className="text-[16px] font-normal leading-[25.6px] text-[#353535]">
            Programming club members are required to participate in our ongoing coding contest instead
            of submitting regular tasks. Showcase your problem-solving skills and compete with peers
            for top rankings!
          </p>
